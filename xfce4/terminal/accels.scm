...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Primary>F11")
...
(gtk_accel_path "<Actions>/terminal-window/contents" "<Primary>F1")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Alt>m")
